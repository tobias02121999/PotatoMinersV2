		...
		obj_level.tileID[cursor.gridPosX, cursor.gridPosY] >= 4)
	{
		if (pickaxe >= obj_level.tileID[cursor.gridPosX, cursor.gridPosY] - 5 && obj_level.tileID[cursor.gridPosX, cursor.gridPosY] != 5)
		{
			...
			else
			{
				...
				{
					case 0: // Stone
						miningCompletion += miningSpeedStone;
						break;
					
					case 2: // Coal
						miningCompletion += miningSpeedCoal;
						break;
					
					case 3: // Iron
						miningCompletion += miningSpeedIron;
						break;
					
					case 4: // Gold
						miningCompletion += miningSpeedGold;
						break;
					
					case 5: // Diamond
						miningCompletion += miningSpeedDiamond;
						break;
				}
			}
		}
